...
type Messages = {
  ...
  "chat": {
    ...
    "tool": {
      ...
      "editWorkspaceDocumentApplied": "Applied {applied, plural, one {# edit} other {# edits}}";
      "editWorkspaceDocumentAppliedWithSkipped": "Applied {applied, plural, one {# edit} other {# edits}} ({skipped, plural, one {# skipped} other {# skipped}})";
      "editWorkspaceDocumentAuthorNameDialogDescription": "Automatic document edits are attributed to you as the tracked-changes author. Set a preferred name to continue.";
      "editWorkspaceDocumentAuthorNameDialogTitle": "Set your name for tracked changes";
      "editWorkspaceDocumentRepresentationDirect": "Rewrite";
      "editWorkspaceDocumentRepresentationTrackedChanges": "Track changes";
      "editWorkspaceDocumentSetNameAction": "Set your name";
      "editWorkspaceDocumentSummary": "{count, plural, one {# edit} other {# edits}}";
      "edit_workspace_document": "Editing document";
